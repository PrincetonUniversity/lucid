(**** 
  Constants used by the Tofino backend.  
...
let timestamp_name = Cid.create [md_instance_prefix; dpt_meta_str; timestamp_str]

let exit_event_field = Cid.create [md_instance_prefix; dpt_meta_str; exit_event_str]
let next_event_field = Cid.create [md_instance_prefix; dpt_meta_str; next_event_str]

let parse_root_name = Cid.create ["start"]
let handle_selector_name = Cid.create [md_instance_prefix; dpt_meta_str; handle_selector_str]
