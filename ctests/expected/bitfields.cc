...
event_variant hdr_900(uint8_t ver_894 , uint16_t len_895 , uint64_t dst_896 , uint64_t src_897 , uint16_t ety_898 ){
  event_variant ev  = {0};
  ev.payload.hdr_900.ver_894 = ver_894;
  ev.payload.hdr_900.len_895 = len_895;
  ev.payload.hdr_900.dst_896 = dst_896;
  ev.payload.hdr_900.src_897 = src_897;
  ev.payload.hdr_900.ety_898 = ety_898;
  ev.tag = hdr_tag;
  return ev;
}
typedef struct {
...
events mk_hdr(uint8_t ver_894 , uint16_t len_895 , uint64_t dst_896 , uint64_t src_897 , uint16_t ety_898 ){
  events tmp_957  = {.meta = {.len = 16, .is_packet = 1, .has_payload = 1, .timestamp = 0, .in_port = 0}, .data = hdr_900(ver_894, len_895, dst_896, src_897, ety_898)};
  return tmp_957;
}
...
uint16_t handle_event(events*  ev_in , out_event out_events [64]){
  ...
  switch (ev_in->data.tag) {
    case 1: {
      uint8_t ver_901  = ev_in->data.payload.hdr_900.ver_894;
      uint16_t len_902  = ev_in->data.payload.hdr_900.len_895;
      uint64_t dst_903  = ev_in->data.payload.hdr_900.dst_896;
      uint64_t src_904  = ev_in->data.payload.hdr_900.src_897;
      uint16_t ety_905  = ev_in->data.payload.hdr_900.ety_898;
      events this  = mk_hdr(ver_901, len_902, dst_903, src_904, ety_905);
      out_event tmp_958  = {.ev = mk_hdr(ver_901, len_902 + 1 & 4095, dst_903, src_904, ety_905), .out_loc = 2, .port = ev_in->meta.in_port};
...
void deparse_event(events*  ev_out , packet_t*  buf_out ){
  switch (ev_out->data.tag) {
    case 1: {
      uint8_t ver_894  = ev_out->data.payload.hdr_900.ver_894;
      uint16_t len_895  = ev_out->data.payload.hdr_900.len_895;
      uint64_t dst_896  = ev_out->data.payload.hdr_900.dst_896;
      uint64_t src_897  = ev_out->data.payload.hdr_900.src_897;
      uint16_t ety_898  = ev_out->data.payload.hdr_900.ety_898;
