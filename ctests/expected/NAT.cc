...
event_variant inside_packet_4039(uint32_t src_ip_4037 , uint32_t src_port_4038 ){
  event_variant ev  = {0};
  ev.payload.inside_packet_4039.src_ip_4037 = src_ip_4037;
  ev.payload.inside_packet_4039.src_port_4038 = src_port_4038;
  ev.tag = inside_packet_tag;
  return ev;
}
event_variant inside_continue_4041(uint32_t src_port_4040 ){
  event_variant ev  = {0};
  ev.payload.inside_continue_4041.src_port_4040 = src_port_4040;
  ev.tag = inside_continue_tag;
  return ev;
}
event_variant outside_packet_4043(uint32_t dst_port_4042 ){
  event_variant ev  = {0};
  ev.payload.outside_packet_4043.dst_port_4042 = dst_port_4042;
  ev.tag = outside_packet_tag;
  return ev;
}
event_variant outside_continue_4046(uint32_t dst_ip_4044 , uint32_t dst_port_4045 ){
  event_variant ev  = {0};
  ev.payload.outside_continue_4046.dst_ip_4044 = dst_ip_4044;
  ev.payload.outside_continue_4046.dst_port_4045 = dst_port_4045;
  ev.tag = outside_continue_tag;
  return ev;
}
event_variant add_to_nat_4049(uint32_t src_ip_4047 , uint32_t src_port_4048 ){
  event_variant ev  = {0};
  ev.payload.add_to_nat_4049.src_ip_4047 = src_ip_4047;
  ev.payload.add_to_nat_4049.src_port_4048 = src_port_4048;
...
uint16_t handle_event(events*  ev_in , out_event out_events [64]){
  ...
  switch (ev_in->data.tag) {
    case 2: {
      uint32_t src_port_4050  = ev_in->data.payload.inside_continue_4041.src_port_4040;
      events this  = mk_inside_continue(src_port_4050);
      break;
    }
    case 4: {
      uint32_t dst_ip_4051  = ev_in->data.payload.outside_continue_4046.dst_ip_4044;
      uint32_t dst_port_4052  = ev_in->data.payload.outside_continue_4046.dst_port_4045;
      events this  = mk_outside_continue(dst_ip_4051, dst_port_4052);
      break;
    }
    case 5: {
      uint32_t src_ip_4053  = ev_in->data.payload.add_to_nat_4049.src_ip_4047;
      uint32_t src_port_4054  = ev_in->data.payload.add_to_nat_4049.src_port_4048;
      events this  = mk_add_to_nat(src_ip_4053, src_port_4054);
      ...
      out_event tmp_4337  = {.ev = mk_inside_continue(NAT_port_4055), .out_loc = 1, .port = 0};
      out_events[n] = tmp_4337;
      n = n + 1;
      break;
    }
    case 1: {
      uint32_t src_ip_4056  = ev_in->data.payload.inside_packet_4039.src_ip_4037;
      uint32_t src_port_4057  = ev_in->data.payload.inside_packet_4039.src_port_4038;
      events this  = mk_inside_packet(src_ip_4056, src_port_4057);
      ...
      if (ret_4059 == true) {
        ...
        out_event tmp_4340  = {.ev = mk_inside_continue(NAT_port_4064), .out_loc = 1, .port = 0};
        out_events[n] = tmp_4340;
        n = n + 1;
      }else {
        printf("Adding to NAT");
        out_event tmp_4341  = {.ev = mk_add_to_nat(src_ip_4056, src_port_4057), .out_loc = 1, .port = 0};
    ...
    case 3: {
      uint32_t dst_port_4065  = ev_in->data.payload.outside_packet_4043.dst_port_4042;
      events this  = mk_outside_packet(dst_port_4065);
      ...
      if (ip_4066 == 0) {
        ...
        out_event tmp_4342  = {.ev = mk_outside_continue(ip_4066, port_4067), .out_loc = 1, .port = 0};
...
void deparse_event(events*  ev_out , packet_t*  buf_out ){
  switch (ev_out->data.tag) {
    case 1: {
      uint32_t src_ip_4037  = ev_out->data.payload.inside_packet_4039.src_ip_4037;
      uint32_t src_port_4038  = ev_out->data.payload.inside_packet_4039.src_port_4038;
    ...
    case 2: {
      uint32_t src_port_4040  = ev_out->data.payload.inside_continue_4041.src_port_4040;
    ...
    case 3: {
      uint32_t dst_port_4042  = ev_out->data.payload.outside_packet_4043.dst_port_4042;
    ...
    case 4: {
      uint32_t dst_ip_4044  = ev_out->data.payload.outside_continue_4046.dst_ip_4044;
      uint32_t dst_port_4045  = ev_out->data.payload.outside_continue_4046.dst_port_4045;
    ...
    case 5: {
      uint32_t src_ip_4047  = ev_out->data.payload.add_to_nat_4049.src_ip_4047;
      uint32_t src_port_4048  = ev_out->data.payload.add_to_nat_4049.src_port_4048;
