...
def test_generator_app():
    ...
    generate_port("veth257", 1, ["00:09", "01:02:03:04:05:06", "07:08:09:10:11:12", "08:00", "bb:aa:dd:aa:ff"])
    time.sleep(2)
    # send_report(4)
    generate_port("veth257", 3, ["00:00:00:04"]) 
    time.sleep(2)
    # eth("01:02:03:04:05:06", "07:08:09:10:11:12", "08:00", "bb:aa:dd:aa:ff)
    generate_port("veth261", None, ["01:02:03:04:05:06", "07:08:09:10:11:12", "08:00", "bb:aa:dd:aa:ff"])
    time.sleep(2)
    # send_report(5)
    generate_port("veth257", 3, ["00:00:00:05"]) 
    time.sleep(10)
    print("exiting")
    global stop
    stop = True
...
def generate_port(port_dev : str, evnum, args):
